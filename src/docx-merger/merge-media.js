...
export function prepareMediaFiles(files, media) {
  var count = 1;
...
export function updateMediaRelations(zip, count, _media) {
...
export function updateMediaContent(zip, count, _media) {
...
export function copyMediaFiles(base, _media, _files) {
