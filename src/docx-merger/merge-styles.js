...
export function prepareStyles(files, style) {
  // var self = this;
...
export function mergeStyles(files, _styles) {
...
export function updateStyleRel_Content(zip, fileIndex, styleId) {
...
export function generateStyles(zip, _style) {
  var xml = zip.file("word/styles.xml").asText();
